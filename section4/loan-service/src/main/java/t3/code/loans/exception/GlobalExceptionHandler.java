package t3.code.loans.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleCustomerAlreadyExistsException(LoansAlreadyExistsException ex, WebRequest webRequest) {
